...
import com.example.demo.util.ApiClient_HmacMD5;
...
//    湖北，湖南，江苏，安徽，浙江，上海，福建，江西，广西，广东，海南，贵州云南
    ...
    public List<String> PictureTypes(@PathVariable("province") String province){
        return swipperMapper.getColleges(province);
    }
     ...
     */
    @CrossOrigin(origins = "*",maxAge = 3600)
    @GetMapping("/make_md5/{message}")
    public String makeMD5(@PathVariable("message") String message) throws Exception {
        return hmacMD5.makeMD5(message);
    }
}
