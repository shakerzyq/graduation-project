<template>
	<view>
		<message-list @goGoodsDetail="goGoodsDetail" :reports="reports"></message-list>
	</view>
</template>

<script>
	import messageList from '../../../../components/mesage-list.vue'
	export default {
		data() {
			return {
				flea_id:null,
		...
		methods: {
			...
			async getGoodsComment(flea_id){
				const result = await this.$myRequest({
					url:'/message/getGoodsComments/'+flea_id+'/comment'
				})
